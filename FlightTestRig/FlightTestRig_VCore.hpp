// ==============================================================
//
//	FlightTestRig (Vessel Core Header)
//	=============================
//
...
#define MAX_HIST 127
    ...
    int logState{ 0 };                           // If logging, create DUMP.CSV in the FlightTestRig folder
